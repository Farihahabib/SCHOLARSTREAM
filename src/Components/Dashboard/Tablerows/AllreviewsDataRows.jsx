...
const AllreviewsDataRows = ({ review, refetch }) => {
  ...
  const handleDelete = async () => {
    try {
      // Moderator endpoint - can delete any review
      const response = await axiosSecure.delete(`/reviews/${_id}`);
            ...
            <div className={`relative transform overflow-hidden rounded-xl shadow-2xl transition-all w-full max-w-md ${
              ...
              <div className="p-6">
                ...
                <p className={`text-center mb-6 ${
                  ...
                  Are you sure you want to delete this review by <strong>{studentName}</strong>? This action cannot be undone.
                </p>
